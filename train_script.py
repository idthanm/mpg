...
from optimizer import SingleProcessOptimizer
from policy import PolicyWithValue
from trainer import Trainer
from worker import PPOWorker
...
def main(alg_name):
    ...
    if args.mode == 'training':
        ...
        trainer = Trainer(policy_cls=PolicyWithValue,
                          worker_cls=PPOWorker,
                          learner_cls=None,
                          buffer_cls=None,
                          optimizer_cls=SingleProcessOptimizer,
