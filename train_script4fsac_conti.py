...
def built_FSAC_parser():
    ...
    parser.add_argument('--value_lr_schedule', type=list, default=[3e-6, 1000000, 1e-6])
    parser.add_argument('--cost_value_lr_schedule', type=list, default=[3e-6, 1000000, 1e-6])
    ...
    parser.add_argument('--policy_lr_schedule', type=list, default=[3e-6, 500000, 1e-6])
    parser.add_argument('--lam_lr_schedule', type=list, default=[1e-6, 100000, 1e-6])
    parser.add_argument('--alpha', default='auto')  # 'auto' 0.02
    alpha = parser.parse_args().alpha
    if alpha == 'auto':
        parser.add_argument('--target_entropy', type=float, default=-6)
    parser.add_argument('--alpha_lr_schedule', type=list, default=[1e-6, 500000, 1e-6])
    ...
    parser.add_argument('--model_load_dir', type=str, default='./results/FSAC/HalfCheetah/conti40HalfCheetah-2021-05-13-08-05-26/models')
    parser.add_argument('--model_load_ite', type=int, default=600000)
    parser.add_argument('--ppc_load_dir', type=str, default='./results/FSAC/HalfCheetah/conti40HalfCheetah-2021-05-13-08-05-26/models')
